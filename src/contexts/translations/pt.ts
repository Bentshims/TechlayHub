...
export const pt: Translations = {
  ...
  // Hero Section
  "hero.title": "Transforme seus desafios",
  "hero.subtitle": " em oportunidades digitais",
  ...
  "services.ai.description": "Desenvolvimento de agentes de IA personalizados para automatizar seus processos de negócios e melhorar sua produtividade.",  
  "services.ai.feature1": "Agentes conversacionais",  
  "services.ai.feature2": "Automação empresarial",  
  "services.ai.feature3": "Análise inteligente",  
  "services.ai.feature4": "Integração de API",  
  "services.maintenance.title": "Manutenção e Suporte",  
  "services.maintenance.description": "Serviços contínuos de manutenção, atualizações de segurança e suporte técnico para suas aplicações.",  
  "services.maintenance.feature1": "Manutenção preventiva",  
  "services.maintenance.feature2": "Atualizações de segurança",  
  "services.maintenance.feature3": "Suporte 24/7",  
  "services.maintenance.feature4": "Otimização de desempenho", 

  "technologies.title": "Tecnologias Utilizadas",  
  "technologies.subtitle": "Dominamos as tecnologias mais avançadas para criar soluções robustas e de alto desempenho.",  
  "technologies.frontend": "Frontend",  
  "technologies.backend": "Backend",  
  "technologies.database": "Banco de dados",  
  "technologies.ai": "Inteligência Artificial"  , 
  ...
  'faq.question4': 'O site será bem ranqueado no Google?',
  'faq.answer4': 'Sim. Aplicamos as melhores práticas de SEO desde a criação para garantir que seu site tenha boa visibilidade no Google.',
  ...
  "pricing.starter.feature1": "Site responsivo",
  "pricing.starter.feature2": "Até 3 páginas",
  "pricing.starter.feature3": "Otimização SEO básica",
  "pricing.starter.feature4": "Formulário de contato",
  "pricing.starter.feature5": "Tradução em 1 idioma",
  "pricing.professional.description": "Ideal para empresas em crescimento",
  "pricing.professional.feature1": "Site dinâmico",
  ...
  "pricing.professional.feature5": "Analytics integrado",
  "pricing.professional.feature6": "Tradução em 3 idiomas",
  "pricing.enterprise.description": "Soluções personalizadas",
  ...
  "pricing.enterprise.feature6": "Tradução personalizada",
